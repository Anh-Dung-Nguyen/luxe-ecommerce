        ...
        <div style = {{ maxWidth: "1280px", margin: "0 auto", padding: "3rem 1.5rem" }}>
            ...
            <div style = {{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem", marginBottom: "4rem" }}>
                ...
                <div>
                    ...
                    {/* Autoriser seulement les clients à écrire un avis */}
                    {user && user.role === 'client' && (
                        ...
                        {reviews.map(r => (
                            <Card key = {r.id} style = {{ padding: "1.25rem", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                                <div style = {{ flex: 1 }}>
                                    ...
                                    {r.comment && <p style = {{ color: "var(--textMuted)", fontSize: "14px", lineHeight: 1.6 }}>{r.comment}</p>}
                                </div>
                                
                                {/* BOUTON REPORT POUR LE VENDEUR DU PRODUIT */}
