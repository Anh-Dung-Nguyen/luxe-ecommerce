...
const SellerCouponsPage = () => {
  ...
  return (
    <div style = {{ maxWidth: "1100px", margin: "0 auto", padding: "3rem 1.5rem" }}>
      ...
      {modal && (
        <Modal title = "Create a Promotion" onClose = {() => setModal(false)}>
          <div style = {{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            <input 
            ...
            <input type = "number" placeholder = "Minimum order value ($0)" value = {form.minOrderValue} onChange = {e => setForm({ ...form, minOrderValue: e.target.value })} />
            <input type = "number" placeholder = "Max uses (leave empty for unlimited)" value = {form.maxUses} onChange = {e => setForm({ ...form, maxUses: e.target.value })} />
